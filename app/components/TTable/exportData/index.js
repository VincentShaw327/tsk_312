...
export default class SimpleTable extends PureComponent {
  ...
  export() {
      const tableDom = this._tableBox
          .getElementsByClassName( 'ant-table-body' )[0];
      const btnWrap = this._btn;
  ...
  render() {
    ...
    const { 
expandedRowRender, data: { list, pagination }, loading, columns, selectable, bordered, size = 'middle', children 
} = this.props;
      ...
      <div className={styles.ep_wrap}>
        <div className={styles.operator}>
          ...
          <div className={styles.btn_wrap}>
              导出：<div className={styles.ep_btn} ref={_btn => this._btn = _btn} />
          </div>
        </div>
