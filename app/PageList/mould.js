export const MoldManagement = {
    ...
    component: () => import( /* webpackChunkName: "TMouldModel" */ '../pages/TMould/TMouldModel' ),
}

export const MoldList = {
    path: '/mould/mould_list',
    component: () => import( /* webpackChunkName: "TMouldList" */ '../pages/TMould/TMouldList' ),
}

export const mouldDetail = {
    path: '/mould/mould_detail',
    component: () => import( /* webpackChunkName: "mouldDetail" */ '../pages/TMould/mouldDetail' ),
}
