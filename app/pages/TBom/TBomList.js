...
export default class TBomList extends Component {
    ...
    getTableList() {
        ...
        TPostData(
            ...
            ( res ) => {
                ...
                // this.setState( { tableDataList: list } );
            },
            ( error ) => {
                message.info( error );
            },
    ...
    getProModelList() {
        TPostData(
            '/api/TProduct/product_model', 'ListActive',
            {
                PageIndex: 0,
                PageSize: -1,
                TypeUUID: -1,
 ...
 this.url, 'Update', dat,
    ...
    render() {
        ...
        const HeadContent = (
            <div style={{
marginTop: 15, height: 80, border: 'solid 0px #bbbbbb', borderRadius: 6, paddingLeft: 8,
}}
            >
