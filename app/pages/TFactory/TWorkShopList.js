...
import { fetchWorkshopList } from 'actions/factory'
...
export default class App extends Component {
    ...
    componentWillMount() {
        // this.getWSTypeList();
        // this.getTableList();
        // this.props.dispatch(fetchWorkshopList({current:1}, (respose) => {}))
    }
    ...
    getTableList( que ) {
        const {
current, pageSize, TypeUUID, keyWord,
} = this.state;
        const dat = {
 ...
 this.url, 'ListActive', dat,
    ...
    getWSTypeList( str ) {
        ...
        TPostData(
 '/api/TFactory/workshop_type', 'ListActive', dat,
            ( res ) => {
                const list = [];
 ...
 this.url, 'Inactive', dat,
    ...
    render() {
        ...
        const { workshoplist, total } = this.props.workshop;
        const {
            wsTypeList,
            tableDataList,
            loading,
