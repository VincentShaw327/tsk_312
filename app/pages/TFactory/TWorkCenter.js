...
import { fetchWorkcenterList } from 'actions/procession'
...
export default class TWorkCenter extends Component {
    ...
    getWorkCenterType() {
        /** ** 拉取下拉款类型数据 **** */
        TPostData(
            '/api/TProcess/workcenter_type', 'ListActive', {
                PageIndex: 0,
                PageSize: -1,
                TypeUUID: -1,
            },
...
alt = "这是工作中心图片"
                    ...
                    return ( <Popover placement= "right"
                      content = { content }
trigger = "hover"
                    > { /* <Button>Right</Button> */ } { /* <img height='30' src={auto01}/> */ } <img height= "50"
                          src= {urlBase + e}
                        /> 
                             </Popover>
                    )
                        ...
                        }, */
            {
                ...
                render: ( txt, record ) => {
                    ...
                    return ( <span >
                        <a onClick= {this.toggleUModalShow.bind( this, record )}
                        > 编辑 
...
okText = "确定"
                        ...
                        <a href ="javascript:void 0;"
                          onClick= {this.toggleRender.bind( this, record )}
                        > { /* <Icon type="profile" /> */ } 详情 
                        </a> 
                             </span> )
                    },
                },
            ...
            const WorkCenterDetail = ( <div className ="cardContent"
            > {
                    /* <div>
                ...
                } <TWorkCenterDetail detailMessage = { detailMessage }
workcenterUUID = { detailID }
                /> 
                                       </div>
            );

            const WorkCenterList = ( <div className= "cardContent"
            > { /* <Feature/> */ } { /* SimpleQForm */ } <StandardQForm FormItem = { RFormItem }
submit = { this.handleQuery }
                /> <CreateModal FormItem = { CFormItem }
submit = { this.handleCreat.bind(this) }
                /> <SimpleTable size ="middle"
                  loading = { loading }
data = { Data }
columns = { Tcolumns }
isHaveSelect = { false }
onChange = { this.handleTableChange }
                /> <UpdateModal FormItem = { UFormItem }
...
hideModal = { this.toggleUModalShow }
            ...
            const HeadAction = (
                ...
                //     <Icon type="rollback" />
                // </span>
                <Button onClick = { this.toggleRender.bind(this) }
type = "primary"
                  icon ="rollback"
                > 返回 
                </Button>
            ...
            const HeadContent = ( <div style= {{ height: 100 }}
            >
                <Row type ="flex"
                  justify= "start"
                  align ="middle"
...
src = { urlBase + detailMessage.Image }/>
                </Col >
                <Col span= {6}
                >
                <div style ={
                ...
                >
                <p > 名称： <span > { detailMessage.Name } </span>
                </p >
                <p > 编号： <span > { detailMessage.ID } </span>
                </p >
                </div> 
                </Col> <Col >
                <div style ={
                ...
                >
                <p > 类型： <span > { detailMessage.TypeName } </span>
                </p >
                <p > 所属车间： { detailMessage.WorkshopName } 
                </p> { /* <p>备注：{detailMessage.Note}</p> */ } 
                </div> </Col> 
                </Row> 
                                  </div>
            );
            ...
            return ( <PageHeaderLayout title = { showDetal ? '工作中心详情' : '工作中心' }
action = { showDetal ? HeadAction : '' }
content = { showDetal ? HeadContent : '' }
wrapperClassName = "pageContent"
              BreadcrumbList ={Breadcrumb.BCList}
            >
                { /* <TWorkCenter/> */ } { showDetal ? WorkCenterDetail : WorkCenterList } 
                     </PageHeaderLayout>
            );
        }
    }
