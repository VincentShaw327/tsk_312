...
export default class TAlarmType extends Component {
    constructor( props ) {
        super( props )
        this.state = {
            tableDataList: [],
    ...
    render() {
        const {
tableDataList, loading, current, total, pageSize, updateFromItem, UModalShow,
} = this.state;
        const Data = {
            list: tableDataList,
        ...
        return (
            <PageHeaderLayout title="告警类别" wrapperClassName="pageContent" BreadcrumbList={bcList}>
